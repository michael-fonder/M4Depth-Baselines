...
def main():
    ...
    dataLoader = m_trainer.initDataloader(args.dataset, args.dataset_dir, args.records_dir, num_epochs=args.num_epochs)
    ...
    if args.eval_set_dir is not None:
        eval_dataLoader = m_trainer.initDataloader(args.dataset, args.eval_set_dir, args.records_dir, batch_size=1, num_epochs=None,is_training=False)
