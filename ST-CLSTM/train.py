...
print("root path: %s" % args.root_path)
if args.dataset == "midair":
	TrainImgLoader = midair_dataloader.getTrainingData_MidAir(args.batch_size, os.path.join(*[dir_path, "splits", "midair", "train_data"]), args.root_path)
elif args.dataset == "tartanair":
	TrainImgLoader = tartanair_dataloader.getTrainingData_TartanAir(args.batch_size, os.path.join(*[dir_path, "splits", "tartanair", "train_data"]), args.root_path)
else:
