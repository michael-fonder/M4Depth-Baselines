...
if __name__ == '__main__':
    ...
    print("{:10.4f}, {:10.4f}, {:10.3f}, {:10.3f}, {:10.3f}, {:10.3f}, {:10.3f}, {:10.3f}".format(abs_rel[abs_rel>=0].mean(), sq_rel[sq_rel>=0].mean(), rms[rms>=0].mean(), log_rms[log_rms>=0].mean(), d1_all.mean(), a1.mean(), a2.mean(), a3.mean()))
